package com.example.timezoneaware.ui.auth
...
import com.example.timezoneaware.databinding.FragmentAuthBinding
...
class AuthFragment : Fragment() {
    ...
    private fun navTimeZoneList() {
        findNavController().navigate(R.id.action_authFragment_to_timezoneListFragment)
    }
